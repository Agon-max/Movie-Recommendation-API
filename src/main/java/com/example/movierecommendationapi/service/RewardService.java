...
public class RewardService {
    ...
    @Transactional
    public RewardDto createReward(CreateRewardDto createRewardDto) {
        Reward reward = rewardMapper.toEntity(createRewardDto);
        reward.setId(null);
